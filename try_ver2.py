...
if __name__ == '__main__':
	...
	"""
	df1 = pd.DataFrame({'experts':["e1"]*500,'candidate': [""+i for i in range(500)], 'predicted_tag' : e1 })
	df2 = pd.DataFrame({'experts':["e2"]*500,'candidate':[""+i for i in range(500)], 'predicted_tag' : e2 })
	df3 = pd.DataFrame({'experts':["e3"]*500,'candidate':[""+i for i in range(500)], 'predicted_tag' : e3 })
	df4 = pd.DataFrame({'experts':["e4"]*500,'candidate': [""+i for i in range(500)], 'predicted_tag' : e4 })
	df5 = pd.DataFrame({'experts':["e5"]*500,'candidate':[""+i for i in range(500)], 'predicted_tag' : e5 })
