...
if __name__ == '__main__':
	...
	for i in x_range:
		clf = AdaBoostClassifier(n_estimators=i, base_estimator=DecisionTreeClassifier(
	...
	print("location of dot", best_iter, er_true_test_wei)
	plot_error_rate(er_train_wei, er_val_wei, [best_iter, er_test_wei],
                 "Weighting vote label for adaboost (compare to predicted label)")
	plot_error_rate(er_true_train_wei, er_true_val_wei, [best_iter, er_true_test_wei],
                 "Weighting vote label for adaboost (compare to true label)")
